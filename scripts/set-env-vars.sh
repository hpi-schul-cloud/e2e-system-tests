...
declare -a env_vars=(
  ...
  "CYPRESS_STUDENT_EXTERN_BRB"
  "CYPRESS_STUDENT_EXTERN_BRB_PASSWORD"
  "CYPRESS_STUDENT_EXTERN_DBC"
  "CYPRESS_STUDENT_EXTERN_DBC_PASSWORD"
  "CYPRESS_STUDENT_EXTERN_NBC"
  "CYPRESS_STUDENT_EXTERN_NBC_PASSWORD"
