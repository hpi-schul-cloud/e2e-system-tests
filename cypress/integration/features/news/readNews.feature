Feature: To read a news on the respective dashboards
  ...
  #  Given I am logged in as a 'teacher' at 'brb'
  #  When I go to news overview
  #  Then I can read the news 'this is a school news' with description 'test school news description'
  ...
  #  And I go to a team 'Musik'
  #  When I click on news tab on the team detail page
  #  Then I can read the news 'this is a team news' with description 'test team news description'

  #Scenario: as a post-condition teacher deletes the school news
  #  Given I am logged in as a 'teacher' at 'brb'
  #  When I arrive on the dashboard
  #  And I click on the news teaser 'this is a school news'
  #  When I click on delete button
  #  And I confirm the deletion on confirmation dialog box
  #  Then I do not see the news 'this is a school news'

  #Scenario: as a post-condition teacher deletes the team news
  #  Given I am logged in as a 'teacher' at 'brb'
  #  When I arrive on the dashboard
  #  And I click on the news teaser 'this is a team news'
  #  When I click on delete button
  #  And I confirm the deletion on confirmation dialog box
