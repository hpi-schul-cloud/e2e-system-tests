...
Scenario: Teacher adds, edits and deletes the team event
  ...
  #When I click on Save team event // currently there is a single 'save' button in the modal used multiple time in the DOM on different pages, so this is to be fixed
