Feature: To go to account settings page on default
  ...
  As a user I want to navigation to my account's settings page so that I can see my account details.

  Scenario: I see my e-mail is editable as an interal student user
