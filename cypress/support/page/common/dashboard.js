class Dashboard {
  ...
  constructor() {
    this.welcomeMessage = '[data-testid="welcome-section"]'
    this.dashboardTasksTitle = '[data-testid="dashboard-tasks-title"]'
    this.dashboardTaskCourseName = '[data-testid="task-course-name"]'
    this.dashboardTaskName = '[data-testid="task-name"]'
  }
