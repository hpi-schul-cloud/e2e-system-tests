Cypress.Commands.add("createSchoolAndUsersToLoginToDbc", () => {
  ...
  const privacyCheckboxOnFirstLoginPage = '[name="privacyConsent"]';
  const useOfTermsOnFirstLoginPage = '[name="termsOfUseConsent"]';
  ...
  cy.request({
    ...
    cy.request({
      ...
      cy.get(nextButtonOnFirstLoginPages).click();
      cy.get(nextButtonOnFirstLoginPages).click();
      cy.get(privacyCheckboxOnFirstLoginPage).check();
      cy.get(useOfTermsOnFirstLoginPage).check();
      cy.get(nextButtonOnFirstLoginPages).click();
