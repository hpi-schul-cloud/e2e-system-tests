...
class ToolConfiguration {
  ...
  seeContextExternalToolConfiguratorPage() {
    cy.get(ToolConfiguration.#contextExternalToolConfiguratorPageTitle).should(
      "be.visible"
    );
  }
  ...
  insertToolLink(toolLink) {
    ...
    cy.get(ToolConfiguration.#toolConfigurationSelectItem)
      .contains("CY Test Tool OpenStreetMap")
      .click();
  }
  ...
  fillInToolDisplayName(toolName) {
    cy.get(ToolConfiguration.#toolDisplayNameInputField)
      .find("input")
      .clear()
      .type(toolName);
  }
