...
Feature:  News - To read a news on the respective dashboards
    ...
    Scenario: Teacher creates news, reads them and deletes them
        ...
        Examples:
            ...
            | teacher1_nbc | student1_nbc | nbc       | CypressAut - this is a school news | school news description | CypressAut - News Team | CypressAut - this is a team news | test team news description |
