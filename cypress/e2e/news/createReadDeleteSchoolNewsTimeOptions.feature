...
Feature:  News - To read a news on the respective dashboards
    ...
    Scenario: User creates news with time options, reads them and deletes them
        ...
        Examples:
            ...
            | teacher1_nbc | student1_nbc | nbc       | CypressAut - school news at current time | Remember Examination date        | 0                   | currentTime | vor ein                     | vor ein                   |
            | admin1_nbc   | student1_nbc | nbc       | CypressAut - school news without time    | New member of the teaching staff | notselected         | none        | vor ein                     | vor ein                   |
            | admin1_nbc   | teacher1_nbc | nbc       | CypressAut - school news 7 days ago      | New member of the teaching staff | -7                  | currentTime | vor 7 Tage                  | -7                        |
