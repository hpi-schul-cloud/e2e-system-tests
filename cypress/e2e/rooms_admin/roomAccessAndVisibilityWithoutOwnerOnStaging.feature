...
Feature: Room Administration - Visibility of rooms without an owner assigned
    ...
    Scenario Outline: Room without an assigned owner is visible to the school admin but inaccessible to other users in the room
        ...
        # student  with role 'Read' in room
        Given I am logged in as a '<student>' at '<namespace>'
        # student_1 with role 'Edit' in room
        Given I am logged in as a '<student_1>' at '<namespace>'
        # teacher_1 with role 'administrator' in room
        ...
        When I click on button Open to access the locked room '<room_without_owner>' at position '1'
        ...
        @staging_test
        Examples:
            | admin        | student        | student_1        | teacher_1        | namespace | room_without_owner                                  |
            | admin_hc_nbc | student_hc_nbc | student_1_hc_nbc | teacher_1_hc_nbc | nbc       | cypress-room-without-teacher (please do not delete) |
