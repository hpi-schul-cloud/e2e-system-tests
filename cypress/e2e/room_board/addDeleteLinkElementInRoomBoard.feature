...
Feature: Room Board - Add, delete element Link in the room board
  ...
  As a teacher, I want to add and delete an element Link in the room board, so that I can link an important resouces efficiently.

  Scenario Outline: Add, edit and delete element Link in the room the room board, including pre & post conditions
