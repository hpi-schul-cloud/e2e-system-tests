...
Feature: Room Board - Copying room board with files in a file folder
    ...
    Scenario Outline:  Content editor is able to create, edit and delete a folder in a board
        ...
        Examples:
            ...
            | nbc       | teacher1_nbc   | CypressAut Folder Room | CypressAut Folder Board Original | Cypress Test Files | sample_video_1mb_mp4.mp4 | sample_audio_0.4mb_mp3.mp3 | example_jpg.jpg |
