...
@group-E
@prio_0_dev
Feature: Room Board - Share and import a column in rooms with a teacher from the same school

    As a teacher,
    I want to share a column from a board with another teacher within the same school
    so that the other teacher can import and use this column in their own room's board.

    Scenario Outline: Share and import a column with a Teacher within the same school
        ...
        # second teacher within the same school imports the shared column into a board
