...
Feature: Room Board - Share multi-column board in the rooms with the teacher from different school
    ...
    Scenario Outline: Share a multi-column board with a teacher from different school
        ...
        Examples:
            ...
            | teacher1_dbc | teacherExt1_dbc | dbc       | CypressAut Room Name-1 | CypressAut Room Name-2 | CypressAut Board Title | CypressAut Board Import Title | Copyright data protection | Content etherpad | Content whiteboard | External tools info | External tools protected parameter info |
