...
Feature: Room Board - Collabora spreadsheet file type with full file access (add, edit, delete) with editor permission
    ...
    Scenario Outline:  Teacher is able to create, add content and delete collabora spreadsheet file type in a board
        ...
        Examples:
            ...
            | dbc       | teacher1_dbc | teacher2_dbc | teacher_2      | editor         | CypressAut_Collabora Room | CypressAut_Collabora Board | sample-xlsx.xlsx | Collabora Teacher1 | Collabora Teacher2 |

#@staging_test
#Examples:
#| namespace | teacher_1    | teacher_2    | teacher_2_name | teacher_2_role | room_name                 | board_title                | xlsx_file_name   | value_1            | value_2            |
#| brb       | teacher1_brb | teacher2_brb | Hande          | editor         | CypressAut_Collabora Room | CypressAut_Collabora Board | sample-xlsx.xlsx | Collabora Teacher1 | Collabora Teacher2 |
