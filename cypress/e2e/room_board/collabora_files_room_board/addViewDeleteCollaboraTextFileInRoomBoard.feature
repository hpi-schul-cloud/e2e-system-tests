...
Feature: Room Board - Collabora text file read access (add, view, delete) with viewer permission
    ...
    Scenario Outline:  Teacher is able to open and view collabora text file in a board
        ...
        Examples:
            ...
            | dbc       | teacher1_dbc | teacher2_dbc | teacher_2      | CypressAut Collabora Room | CypressAut Collabora Board | sample-docx.docx | Collabora Teacher1 | Collabora Teacher2 | Sample Caption Text |
