...
Feature: Room Board - Collabora spreadsheet file read access (add, view, delete) with viewer permission
    ...
    Scenario Outline:  Teacher is able to open and view collabora spreadsheet file in a board
        ...
        Examples:
            ...
            | dbc       | teacher1_dbc | teacher2_dbc | teacher_2      | Cypress_Collabora Room | Cypress_Collabora Board | sample-xlsx.xlsx | Collabora Teacher1 | Collabora Teacher2 |

#@staging_test
#Examples:
#| namespace | teacher_1    | teacher_2    | teacher_2_name | room_name               | board_title             | xlsx_file_name   | value_1            | value_2            |
#| brb       | teacher1_brb | teacher2_brb | Hande          | Cypress_Collabora Room  | Cypress_Collabora Board | sample-xlsx.xlsx | Collabora Teacher1 | Collabora Teacher2 |
