...
Feature: Room Board - Collabora full text file access (add, edit, delete) with editor permission
    ...
    Scenario Outline:  Teacher is able to create, add content and delete collabora file in a board
        ...
        Examples:
            ...
            | nbc       | teacher1_nbc | teacher2_nbc | teacher_2      | editor         | CypressAut_Collabora Collabora Room | CypressAut_Collabora Board | sample-docx.docx | Collabora Teacher1 | Collabora Teacher2 |

#@staging_test
#Examples:
#| namespace | teacher_1    | teacher_2    | teacher_2_name | teacher_2_role | room_name                 | board_title                | docx_file_name   | text_1             | text_2             |
#| brb       | teacher1_brb | teacher2_brb | Hande          | editor         | CypressAut_Collabora Room | CypressAut_Collabora Board | sample-docx.docx | Collabora Teacher1 | Collabora Teacher2 |
