...
Feature: Room Board - Add bettermarks Tool in the Room Board
    ...
    Scenario: Add, edit, delete bettermarks Tool to the Room Board, including pre & post conditions
        ...
        When I click on button Add in the modal to add an external tool
        Then I see the tool bettermarks '<bettermarks_edit_title>' in the card
        ...
        @staging_test
        Examples:
            | teacher      | admin      | student      | namespace | room_name         | board_title    | bettermarks_title | bettermarks_edit_title | student_name | student_role | student_school              | external_tool_name |
            | teacher1_nbc | admin1_nbc | student1_nbc | nbc       | Cypress Room Name | Board Cy Title | bettermarks       | bettermarks edited     | Herbert      | Lernend      | Felix Mendelssohn-Gymnasium | bettermarks        |
