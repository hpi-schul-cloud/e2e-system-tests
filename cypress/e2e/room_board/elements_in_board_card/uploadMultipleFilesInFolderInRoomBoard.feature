...
Feature: Room Board - Upload multiple files in folder in board
    ...
    Scenario Outline:  Content editor is able to upload multiple files to folder in a board
        ...
        Examples:
            ...
            | brb       | teacher1_brb   | teacher2_brb | CypressAut Folder Room | CypressAut Folder Board | Unbenannter Ordner   | Cypress Test Files | sample_video_1mb_mp4.mp4 | sample_audio_0.4mb_mp3.mp3 | example_jpg.jpg | sample-pdf.pdf | sample_audio   | 1,83 MB         | 433,52 KB       | 564,48 KB       | 6,96 MB       | 4 Dateien ⋅ 9,76 MB  |
