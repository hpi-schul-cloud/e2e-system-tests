...
Feature: Team - Create, delete and edit operations on Teams
    ...
    Scenario Outline: Teacher create, edit and deletes the team
        ...
        Examples:
            ...
            | teacher1_dbc | dbc       | CypressAut: Create,Edit,Delete Team | This is CRUD team description | CypressAut: Edited Create,Edit,Delete team | This is edited CRUD team description |
