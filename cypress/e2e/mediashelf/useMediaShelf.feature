...
Feature: Media Shelf - To show media shelf with respective functionality
    ...
    Scenario Outline: Teacher uses the media shelf
        ...
        Examples:
            ...
            | admin1_nbc | teacher1_nbc | nbc       | CY Test Tool Hidden | CY Test Tool 1 | CY Test Tool 2 | rgb(255, 255, 255) | rgb(236, 239, 241) | Test Abschnitt | Favoriten             | https://google.com/ |
