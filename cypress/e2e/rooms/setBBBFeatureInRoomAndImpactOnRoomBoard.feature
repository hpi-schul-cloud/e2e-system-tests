...
Feature: Room Board - Room BBB Feature Checkbox Impact on Adding BBB Tool
    ...
    Scenario Outline: Enable feature checkbox in room edit page and check BBB Tool availability in room board
        ...
        Examples:
            ...
            | teacher1_dbc | teacher2_dbc | admin1_dbc | dbc       | CypressAut Room Name | cypress-test-school-1 | Lernbegleitend | teacher_2        | CypressAut Board Title | CypressAut BBB Tool    |

        @staging_test
        Examples:
            | teacher_1    | teacher_2    | admin      | namespace | room_name            | school_name                 | role_name      | participant_name | board_title            | video_conference_title |
            | teacher1_dbc | teacher2_dbc | admin1_dbc | dbc       | CypressAut Room Name | Felix Mendelssohn-Gymnasium | Lernbegleitend | Hande            | CypressAut Board Title | CypressAut BBB Tool    |
