...
Feature: Room - Change room permission (Viewer - Owner)
    ...
    Scenario Outline: Teacher change room permission of other participants, including pre-conditions
        ...
        Examples:
            ...
            | teacher1_nbc | teacher2_nbc | nbc       | Cypress Room Name | Cypress Edited Room Name | cypress-test-school-1 | Lernbegleitend | teacher_2        |

        @staging_test
        Examples:
            | teacher_1    | teacher_2    | namespace | room_name         | room_name_edited         | school_name                 | role_name      | participant_name |
            | teacher1_nbc | teacher2_nbc | nbc       | Cypress Room Name | Cypress Edited Room Name | Felix Mendelssohn-Gymnasium | Lernbegleitend | Hande            |
