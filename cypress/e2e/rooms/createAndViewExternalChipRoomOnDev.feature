...
Feature: Rooms - To create and delete rooms with external teacher
    ...
    Scenario Outline: Teacher creates and deletes room with external teacher
        ...
        # first teacher creates a new room (cypress-test-school-1)
        Given I am logged in as a '<teacher_1>' at '<namespace>'
        ...
        Examples:
            ...
            | teacher1_brb  | teacherExt1_brb | brb       | Cypress Room Name | cypress-test-school-2       | Lernbegleitend | cypressExt       |
