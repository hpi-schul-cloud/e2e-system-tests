...
Feature: Room - Add and delete participants
    ...
    Scenario: Teacher adds participants and deletes participants, including pre-conditions
        ...
        Examples:
            ...
            | teacher1_nbc | teacher2_nbc | nbc       | Cypress Room Name | cypress-test-school-1 | Lernbegleitend | teacher_2        |

        @staging_test
        Examples:
            | teacher_1    | teacher_2    | namespace | room_name         | school_name                 | role_name      | participant_name |
            | teacher1_nbc | teacher2_nbc | nbc       | Cypress Room Name | Felix Mendelssohn-Gymnasium | Lernbegleitend | Hande            |
