...
Scenario Outline: Room Owner invites a teacher from another school, the teacher invites a student from their school, the student can access the room, including pre-conditions
        ...
        When I enter '<participant_name_teacher>' in dropdown Name
        When I select the first name from the dropdown
        When I click on the button Add participant
        Then I see '<participant_name_teacher>' in the room participants list
        ...
        # teacher is able to delete student from external school
        Given I am logged in as a '<teacher>' at '<namespace>'
        When I go to room overview
        ...
        @school_api_test
        Examples:
            |teacher       | teacherExt   | studentExt   | adminExt   | namespace | room_name         | participant_school      | role_name_teacher | participant_name_teacher | role_name_student | participant_name_student |
            | teacher1_brb | teacher2_brb | student2_brb | admin2_brb | brb       | Cypress Room Name | cypress-automated-tests | Lehrkraft         | teacher_2                | Lernend           | student_2                |

        @staging_test
        Examples:
            |teacher       | teacherExt   | studentExt   | adminExt   | namespace | room_name         | participant_school      | role_name_teacher | participant_name_teacher | role_name_student | participant_name_student |
            | teacher1_brb | teacher2_brb | student2_brb | admin2_brb | brb       | Cypress Room Name | Felix Mendelssohn-Gymnasium | Lehrkraft         | karl                     | Lernend           | student_2                |
