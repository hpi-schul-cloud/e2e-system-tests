...
@group-E
@prio_0_staging
Feature: Rooms - Students can only add students from their own classes to a room on BRB
    ...
    Scenario Outline: Teacher adds participants and deletes participants
        ...
        Examples:
            ...
            | brb       | admin1_brb | teacher1_brb | student1_brb | student2_brb | CypressAut Room Name | cypress-test-school-1 | Lernend   | student_1          | student_2          | 2026/27     | 2027/28          | CypressAut Class Name Manage | 2                  | cypress teacher_1 | cypress student_1  | cypress student_2  |

        @staging_test
        Examples:
            | namespace | admin      | teacher      | student_1    | student_2    | room_name            | school_name                 | role_name | participant_name_1 | participant_name_2 | school_year | school_year_next | custom_class_name            | number_of_students | fullname_teacher | fullname_student_1 | fullname_student_2 |
            | brb       | admin1_brb | teacher1_brb | student1_brb | student2_brb | CypressAut Room Name | Felix Mendelssohn-Gymnasium | Lernend   | Kraft              | Strobl             | 2026/27     | 2027/28          | CypressAut Class Name Manage | 2                  | Karl Herzog      | Herbert Kraft      | Amelia Strobl      |
