...
Feature: Room - Students can only add students from their own classes to a room on NBC
    ...
    Scenario: Teacher adds participants and deletes participants, including pre-conditions
        ...
        Examples:
            ...
            | nbc       | admin1_nbc | teacher1_nbc | student1_nbc   | student2_nbc   | Cypress Room Name | cypress-test-school-1 | Lernend        | student_1          | student_2          | 2024/25     | 2025/26               | cyClassNameManage | 2                  | cypress teacher_1 | cypress student_1   | cypress student_2   |

        @staging_test
        Examples:
            | namespace | admin      | teacher      | student_1      | student_2      | room_name         | school_name                 | role_name      | participant_name_1 | participant_name_2 | school_year | school_year_next | custom_class_name | number_of_students | fullname_teacher  | fullname_student_1  | fullname_student_2  |
            | nbc       | admin1_nbc | teacher1_nbc | student1_nbc   | student2_nbc   | Cypress Room Name | Felix Mendelssohn-Gymnasium | Lernend        | Kraft              | Strobl             | 2024/25     | 2025/26          | cyClassNameManage | 2                  | Karl Herzog       | Herbert Kraft       | Amelia Strobl       |
