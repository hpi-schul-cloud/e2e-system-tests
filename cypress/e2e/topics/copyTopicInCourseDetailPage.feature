...
Feature: Topics - Teacher copies a topic in the course
    ...
    Scenario Outline: Teacher copies a topic in the same course
        ...
        # NOTE: Etherpad is disabled, topic created without etherpad content
        Given topic '<topic_name>' with contents exists in the course '<course_name>' with text element '<text_element_title>' geoGebra '<geogebra_title>' and id '<geogebra_id>' task '<task_title>' and link '<task_id>' for '<namespace>'
        ...
        @staging_test
        Examples:
            | teacher      | namespace | topic_name                                  | course_name                           | text_element_title                          | geogebra_title                                 | geogebra_id | task_title                                 | task_id                  |
            | teacher1_nbc | nbc       | CypressAut Topic Creating and Deleting Test | CypressAut Test Creation and Deletion | CypressAut Topic Creating and Deleting Test | CypressAut Title for GeoGebra Element in Topic | kEBfU7AR    | CypressAut Title for Task Element in Topic | 59cce3f6c6abf042248e888d |
