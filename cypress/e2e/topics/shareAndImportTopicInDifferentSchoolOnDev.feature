...
Feature: Topics - Teacher shares a topic to other teacher from different school to import it
    ...
    Scenario Outline: Teacher shares a topic to other teacher from different school
        ...
        Examples:
            ...
            | teacher1_nbc | teacher2_nbc | nbc       | cypress teacher_1  | CypressAut_Mathe course | CypressAut_Mathe Topic Share | CypressAut_Mathe Topic Imported | CypressAut_Mathe Course Imported | Copyright data protection | Geogebra      | Content etherpad |
