...
Feature: Topics - Teacher shares a topic to other teacher from different school to import it
    ...
    Scenario Outline: Teacher shares a topic to other teacher from different school
        ...
        Examples:
            ...
            | teacher2_dbc | teacherExt2_dbc | dbc       | cypress teacher_1  | CypressAut Math course | CypressAut Math Topic Share | CypressAut Math Topic Imported | CypressAut Math Course Imported | Copyright data protection | Geogebra      | Content etherpad |
