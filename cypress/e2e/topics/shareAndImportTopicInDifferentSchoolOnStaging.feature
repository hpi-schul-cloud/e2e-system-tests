...
Feature: Topics - Teacher shares a topic to other teacher from different school to import it
    ...
    Scenario Outline: Teacher shares a topic to other teacher from different school
        ...
        Then I see 'share' info modal information on '<copyright_data_protection>, <geogebra_info>, <content_etherpad>'
        ...
        Examples:
            ...
            | teacher2_brb | teacherExt2_brb | brb       | cypress teacher_1  | CypressAut Math course | CypressAut Math Topic Share | CypressAut Math Topic Imported | CypressAut Math Course Imported | Copyright data protection | Geogebra      | Content etherpad |
