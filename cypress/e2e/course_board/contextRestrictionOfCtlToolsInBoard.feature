...
Feature: Media Shelf - Restrict CTL tools to context board-element
    ...
    Scenario: Teacher adds tools with context restriction board-element in a board
        ...
        When I click the add external tool button
        When I select the tool '<ctl_tool_restriction_boad_element>' from available tools
        When I click on save external tool button
        Then I see the tool '<ctl_tool_restriction_boad_element>' in external tools table
        Then I see the tool '<ctl_tool_restriction_boad_element>' in external tools table has context restriction '<context_board_element>'
        When I click the add external tool button
        ...
        When I select the tool '<ctl_tool_restriction_boad_element>' from available tools
        Then I see tool '<ctl_tool_restriction_boad_element>' is selected
        When I click on save external tool button
        Then I see an external tool element with tool '<ctl_tool_restriction_boad_element>'
        ...
        When I click on delete button of tool '<ctl_tool_restriction_boad_element>'
        When I confirm deletion on deletion dialog
        Then I do not see the tool '<ctl_tool_restriction_boad_element>' in external tools table
        ...
        @staging_test
        Examples:
            | admin      | teacher      | namespace | course_name         | fullname_teacher | ctl_tool_1     | ctl_tool_restriction_course     | ctl_tool_restriction_boad_element      | ctl_tool_restriction_media_board     | ctl_tool_restriction_all      | ctl_tool_preferred_restriction_course     | ctl_tool_preferred_restriction_board_element | context_course | context_board_element | context_media_board | context_all                       |
