...
Feature: Course Board - To create, edit and delete a single-column course board
    ...
    Scenario Outline: user creation, course creation, and creating single-column board, adding a card with text and whiteboard, deleting the single-column board in the course
        ...
        Examples:
            ...
            | teacher1_nbc | admin1_nbc | student1_nbc | nbc       | cypress teacher_1 | cypress student_1 | CypressAut Single Column Board Course | CypressAut Single Column Board | My Cypress Test Column | Edit Cypress Test Column  | Lorem ipsum ...   |

        @staging_test
        Examples:
            | teacher      | admin      | student      | namespace | fullname_teacher | fullname_student | course_name                           | board_title      | column_board_title     | edited_column_board_title | card_text_content |
            | teacher1_nbc | admin1_nbc | student1_nbc | nbc       | Karl Herzog      | Herbert Kraft    | CypressAut Single Column Board Course | CypressAut Board | My Cypress Test Column | Edit Cypress Test Column  | Lorem ipsum ...   |
