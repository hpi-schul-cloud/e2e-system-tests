...
Feature: Course Board - To create, edit and delete a single-column course board
    ...
    Scenario Outline: user creation, course creation, and creating single-column board, adding a card with text and whiteboard, deleting the single-column board in the course
        ...
        Examples:
            ...
            | teacher1_dbc | admin1_dbc | student1_dbc | dbc       | cypress teacher_1 | cypress student_1 | CypressAut Single Column Board Course | CypressAut Single Column Board | CypressAut Test Column | CypressAut Test Column Edited | Lorem ipsum ...   |

        @staging_test
        Examples:
            | teacher      | admin      | student      | namespace | fullname_teacher | fullname_student | course_name                           | board_title      | column_board_title     | edited_column_board_title     | card_text_content |
            | teacher1_dbc | admin1_dbc | student1_dbc | dbc       | Karl Herzog      | Herbert Kraft    | CypressAut Single Column Board Course | CypressAut Board | CypressAut Test Column | CypressAut Test Column Edited | Lorem ipsum ...   |
