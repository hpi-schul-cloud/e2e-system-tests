...
Feature: Course Board - Copy course with a board which has CTL tools
    ...
    Scenario Outline: Teacher copies a course with a board that has ctl tools
        ...
        Then I see 'copy' info modal information on '<copyright_data_protection>, <course_member_permission>, <course_data>'
        ...
        Examples:
            ...
            | admin1_nbc | teacher1_nbc | student1_nbc | nbc       | CypressAut Copy Course With Ctl In Board | CypressAut Copy Course With Ctl In Board (1) | Karl Herzog      | Kraft        | CY Test Tool Context Scope | CY Test Tool Optional Protected Parameter | CY Test Tool Protected Parameter | searchparam         | search              | test               | protected            | protected             | Ja                             | https://google.com/ | Copyright data protection | Course member permission | Course data |

        @school_api_test
        Examples:
            | admin      | teacher      | student      | namespace | course_name                              | course_name_copy                             | fullname_teacher  | name_student | ctl_tool_scope_context     | ctl_tool_optional_protected_param         | ctl_tool_protected_param         | param_search_1_name | param_search_2_name | param_search_value | param_protected_name | param_protected_value | param_required_protected_value | ctl_tool_launch_url | copyright_data_protection | course_member_permission | course_data |
            | admin1_nbc | teacher1_nbc | student1_nbc | nbc       | CypressAut Copy Course With Ctl In Board | CypressAut Copy Course With Ctl In Board (1) | cypress teacher_1 | student_1    | CY Test Tool Context Scope | CY Test Tool Optional Protected Parameter | CY Test Tool Protected Parameter | searchparam         | search              | test               | protected            | protected             | Ja                             | https://google.com/ | Copyright data protection | Course member permission | Course data |
