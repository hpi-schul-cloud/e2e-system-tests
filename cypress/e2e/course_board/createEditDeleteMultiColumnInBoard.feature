...
Feature: Course Board - To create, edit and delete column in the course board
    ...
    Scenario Outline: user creation, course creation, and creating, editing, deleting a column board in the course
        ...
        Examples:
            ...
            | teacher1_nbc | admin1_nbc | nbc       | cypress teacher_1 | CypressAut Column Board Course | Board Cy Title | My Cypress Test Column | Edit Cypress Test Column  |

        @staging_test
        Examples:
            | teacher      | admin      | namespace | fullname_teacher | course_name                    | board_title    | column_board_title     | edited_column_board_title |
            | teacher1_nbc | admin1_nbc | nbc       | Karl Herzog      | CypressAut Column Board Course | Board Cy Title | My Cypress Test Column | Edit Cypress Test Column  |
