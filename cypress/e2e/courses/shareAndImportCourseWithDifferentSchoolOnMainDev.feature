...
Feature: Course - Teacher shares a course to other teacher from different school
    ...
    Scenario Outline: Teacher shares a course to other teacher from different school
        ...
        Examples:
            ...
            | teacher1_nbc | teacher2_nbc | nbc       | cypress teacher_1  | CypressAut_Mathe course to share | CypressAut_Mathe Task | CypressAut_Mathe Board | CypressAut_Mathe task for Class | CypressAut_Mathe Topic | CypressAut_Mathe course imported | Copyright data protection | Course member permission | Geogebra      | Content etherpad | Content whiteboard | External tools info | External tools protected parameter info | Coursefiles info |
