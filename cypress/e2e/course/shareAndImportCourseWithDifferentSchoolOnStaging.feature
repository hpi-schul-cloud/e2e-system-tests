...
Feature: Course - Teacher shares a course to other teacher from different school
    ...
    Scenario Outline: Teacher shares a course to other teacher from different school
        ...
        Examples:
            ...
            | teacher1_brb | teacherExt1_brb | brb       | cypress teacher_1  | Mathe course to share | Mathe Task | Mathe Board | Mathe task for Class | Mathe Topic      | Mathe course imported |
