...
Feature: Course - To search for a course via search input box on the course overview page
    ...
    Scenario Outline: user creation, course creation, and search functionality
        ...
        Examples:
            ...
            | admin1_dbc | teacher1_dbc | student1_dbc | dbc       | CypressAut Search Course | Cy::NotExistingMathematikCourse | cypress teacher_1 | cypress student_1 |

        @staging_test
        Examples:
            | admin      | teacher      | student      | namespace | created_course_name      | nonexistent_course_name         | fullname_teacher | fullname_student |
            | admin1_dbc | teacher1_dbc | student1_dbc | dbc       | CypressAut Search Course | Cy::NotExistingMathematikCourse | Karl Herzog      | Herbert Kraft    |
