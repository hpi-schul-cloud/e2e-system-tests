...
Feature: Course - Copy course
    ...
    Scenario: Teacher copies a course
        ...
        Examples:
            ...
            | admin1_nbc | teacher1_nbc | student1_nbc | nbc       | CypressAut CourseCopy | CypressAut CourseCopy (1) | cypress teacher_1 | cypress student_1 | student_1            | Cypress Board for Copy Course | Cypress File Folder | example_jpg.jpg |

        @staging_test
        Examples:
            | admin      | teacher      | student      | namespace | course_name           | course_name_copy          | fullname_teacher | fullname_student | board_title                   | folder_name         |
            | admin1_nbc | teacher1_nbc | student1_nbc | nbc       | CypressAut CourseCopy | CypressAut CourseCopy (1) | Karl Herzog      | Herbert Kraft    | Cypress Board for Copy Course | Cypress File Folder |
