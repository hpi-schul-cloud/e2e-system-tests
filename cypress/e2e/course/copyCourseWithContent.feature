...
Feature: Course - Copy course
    ...
    Scenario: Teacher copies a course
        ...
        Examples:
            ...
            | admin1_dbc | teacher1_dbc | student1_dbc | dbc       | CypressAut CourseCopy | CypressAut CourseCopy (1) | cypress teacher_1 | cypress student_1 | student_1            | Cypress Board for Copy Course | Cypress File Folder | example_jpg.jpg |
