...
Feature: Course - Teacher can create, edit and delete a group in the course
    ...
    Scenario Outline: user creation, course creation, and creating,editing and deleting a group
        ...
        Examples:
            ...
            | admin1_nbc | teacher1_nbc | student1_nbc | nbc       | CypressAut Group Course | cypress teacher_1 | cypress student_1 | Group-Work | cypress student_1 | Gruppe-Arbeit |

        @staging_test
        Examples:
            | admin      | teacher      | student      | namespace | course_name             | fullname_teacher | fullname_student | group_name | group_member  | group_rename  |
            | admin1_nbc | teacher1_nbc | student1_nbc | nbc       | CypressAut Group Course | Karl Herzog      | Herbert Kraft    | Group-Work | Herbert Kraft | Gruppe-Arbeit |
