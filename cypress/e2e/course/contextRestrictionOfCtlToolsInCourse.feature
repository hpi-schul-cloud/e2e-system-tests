...
Feature: Media Shelf - Restrict CTL tools to context course
    ...
    Scenario: Teacher adds tools with context restriction course in a course
        ...
        @staging_test
        Examples:
            | admin      | teacher      | namespace | course_name         | fullname_teacher | ctl_tool_1     | ctl_tool_restriction_course     | ctl_tool_restriction_boad_element      | ctl_tool_restriction_media_board     | ctl_tool_restriction_all      | context_course | context_board_element | context_media_board | context_all                       |
