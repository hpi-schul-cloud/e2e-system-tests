...
Feature: Course - Teacher can share a course with CTL tools
    ...
    Scenario Outline: Teacher shares course with ctl tools
        ...
        Then I see modal information 'share' on '<copyright_data_protection>, <course_member_permission>, <geogebra_info>, <content_etherpad>, <content_whiteboard>, <external_tools_info>, <external_tools_protected_parameter_info>, <coursefiles_info>'
        ...
        @staging_test
        Examples:
            | admin      | teacher_1    | teacher_2    | namespace | fullname_teacher_1 | course_name_share       | course_name_import       | ctl_tool_scope_context     | ctl_tool_optional_protected_param         | ctl_tool_protected_param         | param_search_1_name | param_search_2_name | param_search_value | param_protected_name | param_protected_value | param_required_protected_value | copyright_data_protection | course_member_permission | geogebra_info | content_etherpad | content_whiteboard | external_tools_info | external_tools_protected_parameter_info | coursefiles_info |
            | admin1_nbc | teacher1_nbc | teacher2_nbc | nbc       | Karl Herzog        | CypressAut Course Share | CypressAut Course Import | CY Test Tool Context Scope | CY Test Tool Optional Protected Parameter | CY Test Tool Protected Parameter | searchparam         | search              | test               | protected            | protected             | Ja                             | Copyright data protection | Course member permission | Geogebra      | Content etherpad | Content whiteboard | External tools info | External tools protected parameter info | Coursefiles info |

        @school_api_test
        Examples:
            | admin      | teacher_1    | teacher_2    | namespace | fullname_teacher_1 | course_name_share       | course_name_import     | ctl_tool_scope_context     | ctl_tool_optional_protected_param         | ctl_tool_protected_param         | param_search_1_name | param_search_2_name | param_search_value | param_protected_name | param_protected_value | param_required_protected_value | copyright_data_protection | course_member_permission | geogebra_info | content_etherpad | content_whiteboard | external_tools_info | external_tools_protected_parameter_info | coursefiles_info |
            | admin1_nbc | teacher1_nbc | teacher2_nbc | nbc       | cypress teacher_1  | CypressAut Course Share | CypressAut Test Import | CY Test Tool Context Scope | CY Test Tool Optional Protected Parameter | CY Test Tool Protected Parameter | searchparam         | search              | test               | protected            | protected             | Ja                             | Copyright data protection | Course member permission | Geogebra      | Content etherpad | Content whiteboard | External tools info | External tools protected parameter info | Coursefiles info |
