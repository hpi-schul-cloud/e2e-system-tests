...
Feature: Course - To add and delete a course by the teacher
  ...
  Scenario: Create, edit and delete a course
    ...
    Then I enter the course title 'Cypress Test Creation and Deletion'
  ...
  # Editing the course
    ...
    Then I edit the title of the room to 'Cypress Testkurs Edit'
    Then I edit the room description to 'cy edit this is test description'
