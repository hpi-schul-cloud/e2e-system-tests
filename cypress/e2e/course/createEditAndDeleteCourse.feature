...
#     # Then I do not see the course 'Cypress Test Creation and Deletion' on the course overview page -> do we need this for staging?
#     # When I delete all courses named 'Cypress Testkurs Edit' -> do we need this for staging?
#     # Then I do not see the course 'Cypress Testkurs Edit' on the course overview page -> do we need this for staging?
