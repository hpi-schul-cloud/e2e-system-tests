...
# teacher creates course
  ...
  # Deleting the course/room created in this feature test
    ...
    Examples:
      ...
      | dbc       | teacher1_dbc | cypress teacher_1 | CypressAut Test Creation and Deletion | CypressAut Testkurs Edit | cy edit this is test description |

    @staging_test
    Examples:
      | namespace | teacher      | fullname_teacher | course_title                          | course_title_edited      | course_description               |
      | dbc       | teacher1_dbc | Karl Herzog      | CypressAut Test Creation and Deletion | CypressAut Testkurs Edit | cy edit this is test description |
