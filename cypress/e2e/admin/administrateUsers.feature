...
Feature: Admin - To add, edit and delete new users by the admin.
    ...
    Scenario Outline: Admin adds, edits, and deletes a student
        ...
        Examples:
            ...
            | nbc       | admin1_nbc | student        | cypress         | student_admin_test | original_student_admin_users@cypress-mail.de | cypress                | edited_student_admin_test | edited_student_admin_users@cypress-mail.de |
    ...
    Scenario Outline: Admin adds, edits, and deletes a teacher
        ...
        Examples:
            | namespace | admin      | role_to_manage | user_first_name | user_last_name     | user_email                                   | user_first_name_edited | user_last_name_edited     | user_email_edited                          |
            | nbc       | admin1_nbc | teacher        | cypress         | teacher_admin_test | original_teacher_admin_users@cypress-mail.de | cypress                | edited_teacher_admin_test | edited_teacher_admin_users@cypress-mail.de |
