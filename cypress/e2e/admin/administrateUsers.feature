...
Feature: Admin - To add, edit and delete new users by the admin.
    ...
    Scenario: Adding a new user, edit and delete this user
        ...
        Examples:
            ...
            | nbc       | admin1_nbc | student        | cypress        | student_admintest | original_student_adminusers@cypress-mail.de | cypress               | edited_student_admintest | edited_student_adminusers@cypress-mail.de |
            | nbc       | admin1_nbc | teacher        | cypress        | teacher_admintest | original_teacher_adminusers@cypress-mail.de | cypress               | edited_teacher_admintest | edited_teacher_adminusers@cypress-mail.de |
